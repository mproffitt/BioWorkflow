...
for file in ${merged_bam_list[*]}; do
    ...
    command="java -jar ${output_dir}/../tools/picard-tools-2.5.0/picard.jar MarkDuplicates INPUT=${file} OUTPUT=${temp_bam_folder}/${mark_output} METRICS_FILE=${picard_metrics_dir}/$(basename ${file}).txt REMOVE_DUPLICATES=TRUE"
